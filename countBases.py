...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(description="A program to count the number of bases at each position in a region. The command generates a csv file (default: output.csv, use `-o` or `--output` to change) with 3 columns; start of region, end of region, A, C, G, T.")
